...
// mocked payment for a job (GET /bookings/:id?include=payment). Implements the four UI
...
export interface PaymentCardProps {
  payment: PaymentDTO | undefined | null;
  isLoading?: boolean;
  isError?: boolean;
  error?: unknown;
  onRetry?: () => void;
  ...
  if (isLoading) {
    ...
    body = (
      <EmptyState
        ...
        description="This job has no mocked payment yet."
      />
    );
  } else {
    body = (

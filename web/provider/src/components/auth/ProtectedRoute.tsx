...
// src/components/auth/ProtectedRoute.tsx (04 §3.3) — PROVIDER guard.
// Client-side route guard. The API enforces real RBAC; this is defense-in-UX.
...
export function ProtectedRoute({
  ...
  React.useEffect(() => {
    if (status === 'guest') {
      ...
      // wrong role: provider portal → kick out to /login (token cleared at login screen).

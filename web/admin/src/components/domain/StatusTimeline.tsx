// src/components/domain/StatusTimeline.tsx (04 §A.2.9) — renders the booking lifecycle
// from the per-transition timestamp columns (accepted_at / started_at / completed_at /
// cancelled_at). Each step shows whether it occurred and when.

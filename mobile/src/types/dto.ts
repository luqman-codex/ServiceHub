// src/types/dto.ts
// DTOs copied verbatim from 02-API-CONTRACT.md §6 (shared with the web app's
// src/types/api.ts). Field names are snake_case to match the wire format exactly.
// Money DECIMAL fields are STRINGS; dates are ISO-8601 UTC strings.
...
// Result shape returned by paginated list helpers.
